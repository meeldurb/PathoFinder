...
def build_table(tables_dict, table):
    tk = Tk()
    ...
    cursor = db.cursor()
    atttributes = tables_dict[table] 
    ssw.addColumn('')
    query = "SELECT "
    for attribute in atttributes:
...
if __name__ == '__main__':
    ...
    db_tables = {
        ...
        'project_oligo' : ['oligo_ID', 'project_ID'],
